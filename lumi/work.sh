...
conda deactivate
conda activate Tf
for i in GSE102249 GSE83453
do 
    perl modify_sample.pl $i""_non-normalized.txt aa 
    /home/wenjuan/miniconda3/envs/Tf/bin/Rscript lumi_normalization.R aa
    mv normalized_expression.txt aa    
    perl add_anno.pl GPL10558-50081.txt aa $i.normalized_expression.txt
    mv detectionCall_normalized_expression.txt aa
    perl add_anno.pl GPL10558-50081.txt aa $i.detectionCall_normalized_expression.txt
done 
rm aa 
conda deactivate
