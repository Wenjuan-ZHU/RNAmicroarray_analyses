...
data.raw
pdf(file="GSE26155_boxplot_raw.pdf",bg="white");boxplot(data.raw,target='probeset');dev.off()
#=====================Normalization==========================================
...
data.eset
pdf(file="GSE26155_boxplot_afterNormalizing.pdf",bg="white");boxplot(data.eset,target='probeset');dev.off()
...
write.table(data.frame(fdata$probesetid, fdata$geneassignment,fdata$level,data.exprs),file="GSE26155.probeset.normalized_expression.txt",row.names=FALSE, col.names=cnames, sep="\t")
#====P/A filtering=====================
...
pdf(file="GSE26155_hist.pdf",bg="white")
par(mfrow=c(1,2))
